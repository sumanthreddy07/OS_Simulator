...
/* Giving session to the file system to remeber it when opening it again */ 
...
/* fileSystem  class which handles all the file system operations cut , copy , add file .. etc 
*  remmember all commands to keep the files and folders if you open the file system again
*/ 
