...
function displayBlock(i){
  ...
  else $("#comments").append("<br>t = "+sequence[i].start+" : "+ sequence[i].type +sequence[i].no+" entered CPU"+" and is being executed<br>");
  ...
  $('#outer-div').append('<div class="block" id="process-'+sequence[i].start +'">'+ sequence[i].type+sequence[i].no +'<div class="bottom">'+ sequence[i].stop +'</div></div>');
